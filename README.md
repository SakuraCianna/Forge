...
- 内置服务扩展覆盖 GitHub、GitLab、Bitbucket、Slack、Notion、Airtable、HubSpot、Todoist、Asana、ClickUp、monday.com、Google Calendar、Calendly、Miro、Zoom、Figma、Gmail、Google Drive、Dropbox、Microsoft 365、Linear、Sentry、Jira Cloud 和 Discord。
