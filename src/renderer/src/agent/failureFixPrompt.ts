  ...
  return [
    ...
    formatPromptSection(
      ...
      [
        ...
        "For separated Spring Boot + frontend scaffolds, keep backend fixes under backend/, frontend fixes under frontend/. For first-pass generated scaffolds retry Maven as mvn -f backend/pom.xml -DskipTests package, and retry frontend as npm --prefix frontend run build unless the existing files prove other roots are already in use.",
