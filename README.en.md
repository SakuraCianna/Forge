...
- More complete P1/P2 tool productization: documentation versioning, caching, and citation UI for `fetchDocs`; broader trusted-source coverage for `webSearch`; true embedding-backed semantic search; preview-environment guidance for browser tools; and real side-effect sandboxes for high-risk tools such as dependency installation, branch/worktree/revert/push.
