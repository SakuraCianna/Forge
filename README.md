...
- 更完整的 P1/P2 工具产品化: `fetchDocs` 的持久缓存、失败 fallback 和更完整引用 UI、`webSearch` 的更多可信源覆盖、真正的 embedding 语义检索、Browser 工具的预览环境引导, 以及依赖安装、分支/worktree/revert/push 等高风险工具的真实副作用沙箱。
