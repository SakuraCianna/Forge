...
- 内置服务扩展覆盖 GitHub、Slack、Notion、Airtable、Google Calendar、Figma、Gmail、Google Drive、Dropbox、Linear、Jira Cloud 和 Discord。
...
- `FORGE_OAUTH_BROKER_BASE_URL`: 启用 Slack、Notion、Airtable、Figma、Dropbox、Jira Cloud 和 Discord 的 brokered 授权入口
