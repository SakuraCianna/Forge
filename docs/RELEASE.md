...
- 2026-06-06 发布用 `npm run dist:win` 退出码为 0, 安装包 `release\Forge-0.2.1-x64-setup.exe` 生成成功, 发布资产 SHA-256 为 `669b43f60660c3379652217cc723181492404619ad8816e1632bb3411db8f972`。
- 2026-06-06 后续代码质量复跑将 Vite 可打包的 renderer/worker 依赖移出 production dependencies 后, 本地安装包 SHA-256 为 `68e9e039b1d97f515186f5ee4347e8c7cd58d5deca499e0d304782581045e014`; 安装包约从 144 MB 降到 104 MB, `app.asar` 约从 168 MB 降到 17 MB, 且不再生成 `app.asar.unpacked`。
