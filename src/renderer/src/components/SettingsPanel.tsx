...
function getGeneralSettingsCopy(language: Language): {
  ...
  if (language === "zh-CN") {
    return {
      ...
      autoRunSafeActionsDescription: "生成计划后自动推进可运行步骤, Full Access 下会继续自动运行命令和内置工具",
      ...
      defaultOpenTargetDescription: "控制启动时打开最近项目还是停在空白工作区",
      fullAccess: "完全访问权限",
      fullAccessDescription: "自动运行本地 Agent 队列中的文件修改, 命令, 内置工具和 Git 动作",
  ...
  return {
    ...
    autoRunSafeActionsDescription:
      "After planning, continue through runnable steps; Full Access keeps running commands and built-in tools automatically",
    ...
    defaultOpenTargetDescription: "Choose whether startup opens the recent project or a blank workspace",
    fullAccess: "Full access",
    fullAccessDescription:
      "Automatically run agent-queued file changes, commands, built-in tools, and Git actions",
    ...
    permissionsDescription:
      "Control which actions can run by default; Full Access takes over local queue gates automatically",
