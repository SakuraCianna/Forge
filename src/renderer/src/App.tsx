...
import { CommandDialog, FeedbackDialog } from "@/components/AppDialogs";
import {
...
import { createProjectUnderstandingContexts } from "@/agent/projectUnderstandingContext";
...
export function App(): ReactElement {
  ...
  async function generateAskResponse({
    ...
    const projectUnderstandingContexts = await createProjectUnderstandingContexts({
      ...
      prompt,
      projectScan,
      readText: window.forge.files.readText
    });
